...
const dropUserTable = () => {
  ...
  pool.query(usersDropQuery)
    .then((res) => {
      console.log('%c In remove users table', 'font-size:20px;color:blue;');
      console.log(res);
      pool.end();
    })
    .catch((err) => {
      console.log('%c In error remove users table', 'font-size:20px;color:blue;');
      console.log(err);
      pool.end();
    });
};
 ...
 */
const dropAllTables = () => {
  console.log('%c In droptables', 'font-size:20px;color:blue;');
  dropUserTable();
  dropBusTable();
  dropTripTable();
  dropBookingTable();
